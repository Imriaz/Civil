              ...
              <div className="col-md-3 col-sm-12">
                <div className="footer-widget">
                  <div className="widget-about">
                    <img src={BUBT_Logo} alt="" className="img-fluid" />
                    <p className="Dept-Name">Department of Civil Engineering</p>
                    <ul className="contact-details">
                      <li>
                        <span className="icon-earphones"></span> Call Us:
                        <a href="tel:017-755-1111">017-755-1111</a>
                      </li>
                      <li>
                        <span className="icon-envelope-open"></span>
                        <a href="mailto:support@civil.bubt.edu.bd">
                          support@civil.bubt.edu.bd
                        </a>
                      </li>
                      <li>
              ...
              <div className="col-md-2 col-sm-6 ">
                <div className="footer-widget">
                  <div className="footer-menu footer-menu--1">
                    ...
                    <ul>
                      <li>
                        <a href="https://annex.bubt.edu.bd/" target="_blank">
                          Student Portal
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a
                          href="https://convocation.bubt.edu.bd/"
                          target="_blank"
                        >
                          Convocation
                        </a>
                      ...
                      <li>
                        <a
                          href="https://www.bubt.edu.bd/Home/page_details/Semester_Policy/"
                          target="_blank"
                        >
                          Semester Policy
                        </a>
                      ...
                      <li>
                        <a
                          href="https://www.bubt.edu.bd/downloads/index/9091/"
                          target="_blank"
                        >
                          Download Center
                        </a>
                ...
                <div className="footer-widget">
                  <div className="footer-menu">
                    ...
                    <ul>
                      <li>
                        <a
                          href="https://www.bubt.edu.bd/Home/page_details/Admission_Notices/"
                          target="_blank"
                        >
                          Admission
                        </a>
                      ...
                      <li>
                        <a
                          href="https://www.bubt.edu.bd/newsletter/"
                          target="_blank"
                        >
                          Newsletter
                        </a>
                ...
                <div className="footer-widget">
                  <div className="footer-menu ">
                    ...
                    <ul>
                      ...
                      <li>
                        <a
                          href="https://www.bubt.edu.bd/home/results"
                          target="_blank"
                        >
                          Results
                        </a>
